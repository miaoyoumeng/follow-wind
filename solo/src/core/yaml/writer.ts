...
import type { PanePosition, PaneEntry, AgentPanes, AgentConfig, SoloConfig, LoggingConfig } from './types';

export type { PanePosition, PaneEntry, AgentPanes, AgentConfig, SoloConfig, LoggingConfig } from './types';
...
const normalize = (data: unknown): SoloConfig => {
  ...
  if (typeof obj.agents !== 'object' || obj.agents === null) return { name, hooks, logging };
