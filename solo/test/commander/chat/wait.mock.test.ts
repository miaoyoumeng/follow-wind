...
const { mockRegisterTask, mockSpawn, mockInfo } = vi.hoisted(() => ({
...
import { waitForIdle } from '../../../src/commander/chat/wait';
...
describe('waitForIdle', () => {
  ...
  it('输出 task 注册日志', () => {
    ...
    expect(mockInfo).toHaveBeenCalledWith(expect.stringContaining('task task-001 registered'));
  });
